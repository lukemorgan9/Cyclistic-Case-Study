...
___________________________________________________________________________________________________
-- #5 Checking start_station_name/start_station_id and end_station_name/end_station_id columns for 
...
/*
NOTES: There are a high number of nulls in station ids and names. Classic bikes need a starting and ending station and so 
       classic bike trips with nulls in those columns will be removed during cleaning. Due to inconsistent formatting in 
       station ids, and their lack of importance in analysis, these columns will be ignored.
___________________________________________________________________________________________________
